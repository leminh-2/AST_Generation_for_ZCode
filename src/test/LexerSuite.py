...
class LexerSuite(unittest.TestCase):
    ...
    def test_Identifiers(self):
        ...
        ##^ test false ID
        self.assertTrue(TestLexer.test("1Minhc", "1,Minhc,<EOF>", 107))
        self.assertTrue(TestLexer.test("11Minhc", "11,Minhc,<EOF>", 108))
    ...
    def test_Literal(self):
        ...
        ##^ test STRING_LIT 
        input = """ "Le  Minh" """ # kiểm tra bình thường
        expect = "Le  Minh,<EOF>"
        ...
        self.assertTrue(TestLexer.test(""" "'"Le '" Minh '' '"" ""","'\"Le '\" Minh '' '\",<EOF>",115))
        
        ##^ kiểm tra lỗi Unclosed String
        self.assertTrue(TestLexer.test(""" "Le \n" """, "Unclosed String: Le ", 116))
        self.assertTrue(TestLexer.test(""" "Le \n Minh" """, "Unclosed String: Le ", 117))
        self.assertTrue(TestLexer.test(""" "Le  """, "Unclosed String: Le  ", 118))
        self.assertTrue(TestLexer.test(""" "Le \\n \n """, "Unclosed String: Le \\n ", 119))
        self.assertTrue(TestLexer.test(""" "Le ' \\n \\b """, "Unclosed String: Le ' \\n \\b ", 120))
        
        ##^ kiểm tra lỗi Illegal Escape
        self.assertTrue(TestLexer.test(""" "Minh ' \\1  """, "Illegal Escape In String: Minh ' \\1", 123))
        self.assertTrue(TestLexer.test(""" "Minh \\2 \\n \n """, "Illegal Escape In String: Minh \\2", 124))
        self.assertTrue(TestLexer.test(""" "Minh \\e \\n \\r """, "Illegal Escape In String: Minh \\e", 125))        
        self.assertTrue(TestLexer.test(""" "Minh '" \\321 \\n \\r """, "Illegal Escape In String: Minh '\" \\3", 126))
        self.assertTrue(TestLexer.test(""" "Minh \\"1 " """, "Illegal Escape In String: Minh \\\"", 127))          
        self.assertTrue(TestLexer.test(""" "Minh ' '" \\" """, "Illegal Escape In String: Minh ' '\" \\\"", 128))
        self.assertTrue(TestLexer.test(""" "Minh \\' ""1 """, "Minh \\' ,Unclosed String: 1 ", 129))  

        
    
    def test_Comments_newline(self):
        """test Comments và newline""" 
        self.assertTrue(TestLexer.test("## Le Minh","<EOF>",130))    
...
,<EOF>"""
    ...
    def test_complex(self): # test case 140 ->
        ...
        self.assertTrue(TestLexer.test(""" "Minh \t \n" """, "Unclosed String: Minh 	 ", 144))
        self.assertTrue(TestLexer.test(""" "Minh \\" """, "Illegal Escape In String: Minh \\\"", 145))
        self.assertTrue(TestLexer.test(""" "Minh \\\n """, "Illegal Escape In String: Minh \\\n", 146))
        self.assertTrue(TestLexer.test(""" "Minh '\\ """, "Illegal Escape In String: Minh '\\ ", 147))
        self.assertTrue(TestLexer.test(""" "Minh \'" " """, "Minh '\" ,<EOF>", 148))
        self.assertTrue(TestLexer.test(""" "Minh \\\'" " """, "Minh \\',Unclosed String:  ", 149))
        self.assertTrue(TestLexer.test(""" "Minh 
                                       " """, "Unclosed String: Minh ", 150))
